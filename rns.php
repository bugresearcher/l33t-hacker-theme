...
class ReactAndShare {
	...
	function __construct() {
		...
		$this->register_url = 'https://dashboard.reactandshare.com/register-wp?callback_url='.$this->settings_url;
		...
		if( get_transient( 'rns-plugin-activation-notice' ) ){
			...
			?>
				<div class="updated notice is-dismissible">
					<p>React & Share Plugin is activated. <a href="https://getreactionbuttons.com">Customize your reaction buttons here</a>.<p>
				<div>
			<?php
	...
	function addMetaLink( $links, $file ) {
		...
		if ( $file == $plugin ) {
			return array_merge(
				$links,
				array( '<a href="https://getreactionbuttons.com">Customize your reaction buttons!</a>' )
			);		
		}
		return $links;
	}
	...
	function renderOptionsPage() {
		...
		<form action='options.php' method='post'>
			...
			<?php if (isset($api_key) && !empty($api_key)) { ?>
				...
				<p style="font-weight: 600; font-size: 22px">1. Edit your reaction buttons</p>
				<p>
				<a href="https://getreactionbuttons.com/?login" target="_blank" style="background: #fa644d; color: #fff; padding: 8px 12px; border-radius: 3px; text-decoration: none; display: inline-block; margin: 0 0 10px 0; width: 300px;text-align: center; font-weight: 600">
					Start here
				</a>
				</p>
			...
			<?php } else { ?>
				...
				<p style="font-weight: 600; font-size: 22px">1. Choose your reaction buttons</p>
				<p>
				<a href="https://getreactionbuttons.com?utm_source=wp_register" target="_blank" style="background: #fa644d; color: #fff; padding: 8px 12px; border-radius: 3px; text-decoration: none; display: inline-block; margin: 0 0 10px 0; width: 300px;text-align: center; font-weight: 600">
					Start here
				</a>
				</p>
	...
	function renderPlugin($options, $post_object) {
		...
		if (!empty($apiKey)) {
			...
			$plugin .= '></div> <!-- Check out https://getreactionbuttons.com -->';
		}
		else {
